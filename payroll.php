                            ...
                            <div class="row">    
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="food_allowance" placeholder="Enter Food Allowance Amount" type="text" autocomplete="off" name="food_allowance" value="<?php if(isset($_SESSION['session_food_allowance'])) echo htmlspecialchars($_SESSION['session_payroll_food_allowance']); ?>">
                                    </div>
