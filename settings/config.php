<?php
	...
	$arrayDesignations = array('Associate Director','HR-Manager','Project Manager','Team Leader','Senior Programmer','Associate Programmer','Junior Programmer','Accountant','Peon','Driver');
