        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <form role="form" id="appointmentLetter" method="POST" action="AppointmentController.php">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <?php 
                                if(isset($_SESSION['probationer_error'])) {
                            ?>
                                <div class="col-md-12">
                                    <p class="alert alert-danger"><?php echo $_SESSION['probationer_error'];?></p>
                                </div>
                            <?php
                                unset($_SESSION['probationer_error']);  
                                }
                            ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="appointment_text" style="display: none;">
                                        ...
                                        <p>I am pleased to confirm that the board of <b>Tomato Inc.</b>, has appointed you as the
                                        Probationer of <b>Tomato Inc.</b>. I am writing to set out the terms of the appointment.</p>
                                        <p>As a Probationer, you will be entitled to a monthly remuneration of Rs 15,000/- (Rupees
                                        Fifteen Thousands only), which indicates cost to company. Your salary will be reviewed
                                        every 6 months.</p>
                                        <p>You shall receive your payment on or before the 7th day of every month. Leave and other
                                        company policies are available in the company’s EMS (Employee Management System).
                                        A hard copy of company policies is also provided to you. These policies are reviewed and
                                        posted at our EMS from time to time by the management of <b>Tomato Inc.</b> for your
                                        benefit. You shall abide by the terms and conditions of the standing orders and the rules
                                        of the company as in force from time to time.</p>
                                        <p>Your signing this appointment letter confirms your acceptance of the terms and
                                        conditions and that you would be joining <b>Tomato Inc.</b> on the given date.</p>
...
<script type="text/javascript">
    ...
    function getIdFunction(argument1, argument2) {
        ...
        $.ajax({
            ...
            type: "post",
            cache: false,
            data: {"probationer_employee_id": argument1},
            success: function(result1) {
                ...
                if(result1 == 0) {
                    ...
                    swal('Alert','Probatiober appointment letter already generated.','warning');
                    $('textarea').css('display','block');
...
<?php 
    if(isset($_SESSION['probationer_success'])) {
?>
<script type="text/javascript">
    swal('Congrats', 'Probationer Appointment Generated Successfully.', 'success');
</script>
<?php
    unset($_SESSION['probationer_success']);  
    }
?>
<!-- Modal -->
