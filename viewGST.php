...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>GST return for the month <?php echo date("M Y",strtotime($period)); ?></h1>
...
<?php
if(isset($_SESSION['GSTMessage'])) {
    if($_SESSION['GSTMessage'] == 'success') {
?>
    <script type="text/javascript">
        swal('Congrats','GST generated Successfully', 'success');

    </script>
<?php
    }
    if($_SESSION['GSTMessage'] == 'fail') {
?>
    <script type="text/javascript">
